		...
		<div class="row">
			...
			<div class="col inline-block d-flex justify-content-end align-items-center quick-access">
				<ul class="navbar">
					...
					<li class="item"><h6>Giảm giá</h6></li>
				</ul>
			</div>
		</div>
	</div>
...
<div id="menu-action" class="my-4">
	<div class="container py-4">
		...
		<div class="my-4 row">
			<div class="my-2 row col">
				<label class="col text-right" for="start-date">Ngày bắt đầu:</label> <input class="col text-center input" type="date" name="start-date">
			</div>
			
			<div class="my-2 row col">
				<label class="col text-right" for="export">Ngày kết thúc:</label> <input class="col text-center input" type="date" name="end-date">
			</div>
			<div class="col-2"></div>
		</div>
