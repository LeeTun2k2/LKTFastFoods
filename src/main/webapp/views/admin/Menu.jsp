			...
			<form method="get">
				...
				<div class="d-flex justify-content-around">
					<button formaction="${pageContext.request.contextPath}/MenuAdd"
						id="menu-add" class="button">Thêm sản phẩm</button>
					<button formaction="${pageContext.request.contextPath}/MenuUpdate"
						id="menu-edit" class="button">Sửa sản phẩm</button>
					<button type="submit"
						formaction="${pageContext.request.contextPath}/MenuDelete"
						id="menu-delete" class="button">Xóa sản phẩm</button>
				</div>
			</form>
		</div>
	</div>
