...
<div class="app-main__outer">
	<div class="app-main__inner">
		...
		<div class="">
			<!-- Body file -->
			 <form enctype="multipart/form-data" action="<c:url value="/admin/store/update"/>" method="post" >
			 <div class="content">
								...
								<div class="card card-user">
									<div class="image" " >
										<label style="height:100%; width:100%"> <input type="file" accept="image/*"
											...
											style="display: none; cursor: pointer;"> <a> <c:url value="/image?fname=${storeDetail.cover}" var="imgUrl"></c:url>
