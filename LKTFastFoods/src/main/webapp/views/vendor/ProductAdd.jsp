				...
				<div class="main-card mb-3 card"
					...
					<div class="card-body">
						...
						<form enctype="multipart/form-data"
							action="${Url}vendor/addProduct" method="post">
							...
							<div class="position-relative form-group">
								<label for="category" class="">Phân loại </label> <select
									id="cars" name="category">
							...
							<div class="position-relative form-group">
								<label for="Style-color" class="">Màu </label> <select id="cars"
									name="Style-color">
							...
							<div class="position-relative form-group">
								<label for="Style-size" class="">Kích cỡ </label> <select
									id="cars" name="Style-size">
							...
							<div class="position-relative form-group">
								<label for="Style-size" class="">Loai:</label> <select id="cars"
									name="Style-type">
							...
							<div class="position-relative form-group">
								<label for="storeId" class="">Cửa hàng bán sản phẩm :</label> <select
									id="cars" name="storeId">
