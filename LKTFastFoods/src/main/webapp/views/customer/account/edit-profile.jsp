	                ...
	                <div class="card border-secondary mb-5">
	                    ...
	                    <div class="card-body">
			                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
			                    ...
			                    <hr>
			                    <h6 class="font-weight-semi-bold m-0" style="text-align: center;">Dụng lượng file tối đa 1 MB </h6>
			                    <br/>
			                    <h6 class="font-weight-semi-bold m-0" style="text-align: center;">Định dạng: .JPEG, .PNG</h6>
